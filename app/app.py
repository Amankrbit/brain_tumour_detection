...
if not patient_name or patient_age is None or patient_gender == "Select...":
    ...
    if uploaded_file:
        ...
        **1. Procedure Description:**  
        MRI brain performed with and without contrast. Agent used: Gadolinium-based (Assumed standard protocol).

        **2. Findings:**  
        * **Location:** {region_text} (Localized via Grad-CAM algorithmic mapping).
        ...
        * Findings highly suggestive of neoplastic lesion.
